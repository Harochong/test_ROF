...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOTLOADER_PROVISION_HEX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_B0_BUILD_STRATEGY_FROM_SOURCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_PRIVATE_KEY_PROVIDED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_SIGNING_PYTHON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_SIGNING_KEY_FILE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_SIGNING_COMMAND, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_SIGNING_PUBLIC_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_PUBLIC_KEY_FILES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_802154_SER_RADIO_INIT_PRIO, 51);
